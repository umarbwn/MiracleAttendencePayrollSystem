        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary">
                                ...
                                <div class="col-sm-6 col-sm-offset-3">
                                    <div class="form-group
                                        ...
                                        <input
                                            ...
                                            value="<?php echo set_value('email_addr'); ?>"
                                            >
                                            <?php echo $error; ?>
                                    </div>
                                </div>
                    ...
                    <?php else: ?>
                        <div class="box-body">
                            <div class="row top-bottom-gap">
                                <h1 class="text-center">
                                    You haven't added the rate card.
                                    <br>
                                    <small> Please add the rate card first then add employee.</small>
                                </h1>
                                <div class="col-sm-6 col-sm-offset-3">
                                    <div class="form-group">
                                        <a
                                            class="btn btn-primary center-block btn-lg"
                                            href="<?php echo base_url('Payroll/add_rate_card'); ?>">Add rate card</a>
                                    </div>
                                </div>
                            </div>
                        </div>
