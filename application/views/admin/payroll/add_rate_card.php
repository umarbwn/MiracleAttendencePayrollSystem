                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-sm-6 col-sm-offset-3">
                                <div
                                    ...
                                    <input type="text" class="form-control" name="payroll_title" id="first_name"
                        ...
                        <div class="row">
                            <div class="col-sm-3 col-sm-offset-3">
                                <div class="bootstrap-timepicker">
                                    <div class="form-group">
                                        <label class="control-label text-success">Employee Arrivel Time:</label>
                                        <div class="input-group">
                                            <input 
                                                type="text" 
                                                class="form-control timepicker" 
                                                value="<?php
                                                    if(isset($rate_card->arrivel_time)){
                                                        echo set_value('arrivel_time', $rate_card->arrivel_time); 
                                                    } 
                                                ?>" 
                                                name="arrivel_time">
                            ...
                            <div class="col-sm-3">
                                <div class="bootstrap-timepicker">
                                    <div class="form-group">
                                        <label class="control-label text-danger">Add Fine After:</label>
                                        <div class="input-group">
                                            <input 
                                                type="text" 
                                                class="form-control timepicker" 
                                                value="<?php
                                                    if(isset($rate_card->fine_time)){
                                                        echo set_value('fine_time', $rate_card->fine_time); 
                                                    } 
                                                ?>" 
                                                name="fine_time">
                                            <div class="input-group-addon">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-sm-offset-3">
                                <div class="form-group">
                                    <label for="deduct-hours">Deduct hours salary:</label>
                                ...
                                <table class="table table-bordered table-hourly-chart">
                                    <thead>
                                        ...
                                        <tr class="active">
                                            <th class="tbl-cell-header-border"></th>
                                            <th class="text-center tbl-cell-header-border">
                                                <input type="text" class="form-control" name="sun0"
                                                    value="<?php 
                                                        echo set_value('sun0', $hrly_rate_chart['sun0']); 
                                                    ?>">
                                            </th>
                                            <th class="text-center tbl-cell-header-border">
                                                <input type="text" class="form-control" name="mon0"
                                                    value="<?php 
                                                            echo set_value('mon0', $hrly_rate_chart['mon0']);
                                                    ?>">
                                            </th>
                                            <th class="text-center tbl-cell-header-border">
                                                <input type="text" class="form-control" name="tue0"
                                                    value="<?php 
                                                            echo set_value('tue0', $hrly_rate_chart['tue0']);
                                                            ?>">
                                            </th>
                                            <th class="text-center tbl-cell-header-border">
                                                <input type="text" class="form-control" name="wed0"
                                                    value="<?php 
                                                            echo set_value('wed0', $hrly_rate_chart['wed0']);
                                                            ?>">
                                            </th>
                                            <th class="text-center tbl-cell-header-border">
                                                <input type="text" class="form-control" name="thu0"
                                                    value="<?php 
                                                            echo set_value('thu0', $hrly_rate_chart['thu0']);
                                                            ?>">
                                            </th>
                                            <th class="text-center tbl-cell-header-border">
                                                <input type="text" class="form-control" name="fri0"
                                                    value="<?php 
                                                            echo set_value('fri0', $hrly_rate_chart['fri0']);
                                                            ?>">
                                            </th>
                                            <th class="text-center tbl-cell-header-border">
                                                <input type="text" class="form-control" name="sat0"
                                                    value="<?php 
                                        ...
                                        <tr class="text-center my-input-row">
                                            ...
                                            <td>
                                                <input class="form-control" for=""
                                                    name="<?php echo '_am_ip_sun' . $i ?>" id="<?php echo 'sun' . $i ?>"
                                                    value="100%">
                                            </td>
                                            <td>
                                                <input class="form-control" for=""
                                                    name="<?php echo '_am_ip_mon' . $i ?>" id="<?php echo 'mon' . $i ?>"
                                                    value="100%">
                                            </td>
                                            <td>
                                                <input class="form-control" for=""
                                                    name="<?php echo '_am_ip_tue' . $i ?>" id="<?php echo 'tue' . $i ?>"
                                                    value="100%">
                                            </td>
                                            <td>
                                                <input class="form-control" for=""
                                                    name="<?php echo '_am_ip_wed' . $i ?>" id="<?php echo 'wed' . $i ?>"
                                                    value="100%">
                                            </td>
                                            <td>
                                                <input class="form-control" for=""
                                                    name="<?php echo '_am_ip_thu' . $i ?>" id="<?php echo 'thu' . $i ?>"
                                                    value="100%">
                                            </td>
                                            <td>
                                                <input class="form-control" for=""
                                                    name="<?php echo '_am_ip_fri' . $i ?>" id="<?php echo 'fri' . $i ?>"
                                                    value="100%">
                                            </td>
                                            <td>
                                                <input class="form-control" for=""
                                                    name="<?php echo '_am_ip_sat' . $i ?>" id="<?php echo 'sat' . $i ?>"
                                                    value="100%">
                                            </td>
                                        </tr>
                                        <?php endfor;?>
                                ...
                                <table class="table table-bordered table-hourly-chart1">
                                    <thead>
                                        ...
                                        <tr class="active">
                                            <th class="tbl-cell-header-border"></th>
                                            <th class="text-center tbl-cell-header-border">
                                                <input type="text" class="form-control" name="sun0pm"
                                                    value="<?php 
                                                            echo set_value('sun0pm', $hrly_rate_chart['sun0pm']);
                                                            ?>">
                                            </th>
                                            <th class="text-center tbl-cell-header-border">
                                                <input type="text" class="form-control" name="mon0pm"
                                                    value="<?php 
                                                            echo set_value('mon0pm', $hrly_rate_chart['mon0pm']);
                                                            ?>">
                                            </th>
                                            <th class="text-center tbl-cell-header-border">
                                                <input type="text" class="form-control" name="tue0pm"
                                                    value="<?php 
                                                            echo set_value('tue0pm', $hrly_rate_chart['tue0pm']);
                                                            ?>">
                                            </th>
                                            <th class="text-center tbl-cell-header-border">
                                                <input type="text" class="form-control" name="wed0pm"
                                                    value="<?php 
                                                            echo set_value('wed0pm', $hrly_rate_chart['wed0pm']);
                                                            ?>">
                                            </th>
                                            <th class="text-center tbl-cell-header-border">
                                                <input type="text" class="form-control" name="thu0pm"
                                                    value="<?php 
                                                            echo set_value('thu0pm', $hrly_rate_chart['thu0pm']);
                                                            ?>">
                                            </th>
                                            <th class="text-center tbl-cell-header-border">
                                                <input type="text" class="form-control" name="fri0pm"
                                                    value="<?php 
                                                            echo set_value('fri0pm', $hrly_rate_chart['fri0pm']);
                                                            ?>">
                                            </th>
                                            <th class="text-center tbl-cell-header-border">
                                                <input type="text" class="form-control" name="sat0pm"
                                                    value="<?php 
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center my-input-row">
                                            ...
                                            <td>
                                                <input class="form-control" name="<?php echo '_pm_ip_sun' . $i; ?>"
                                                    for="" id="<?php echo 'sun' . $i . 'pm'; ?>" value="100%">
                                            </td>
                                            <td>
                                                <input class="form-control" name="<?php echo '_pm_ip_mon' . $i; ?>"
                                                    for="" id="<?php echo 'mon' . $i . 'pm'; ?>" value="100%">
                                            </td>
                                            <td>
                                                <input class="form-control" name="<?php echo '_pm_ip_tue' . $i; ?>"
                                                    for="" id="<?php echo 'tue' . $i . 'pm'; ?>" value="100%">
                                            </td>
                                            <td>
                                                <input class="form-control" name="<?php echo '_pm_ip_wed' . $i; ?>"
                                                    for="" id="<?php echo 'wed' . $i . 'pm'; ?>" value="100%">
                                            </td>
                                            <td>
                                                <input class="form-control" name="<?php echo '_pm_ip_thu' . $i; ?>"
                                                    for="" id="<?php echo 'thu' . $i . 'pm'; ?>" value="100%">
                                            </td>
                                            <td>
                                                <input class="form-control" name="<?php echo '_pm_ip_fri' . $i; ?>"
                                                    for="" id="<?php echo 'fri' . $i . 'pm'; ?>" value="100%">
                                            </td>
                                            <td>
                                                <input class="form-control" name="<?php echo '_pm_ip_sat' . $i; ?>"
                                                    for="" id="<?php echo 'sat' . $i . 'pm'; ?>" value="100%">
                                            </td>
                                        </tr>
                                        <?php endfor;?>
                                    </tbody>
