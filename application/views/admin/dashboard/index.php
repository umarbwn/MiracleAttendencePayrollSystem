                ...
                <div class="nav-tabs-custom" style="cursor: move;">
                    ...
                    <ul class="nav nav-tabs pull-right ui-sortable-handle">
                        <li>
                            <a href="#add-notice" 
                            data-toggle="tab" 
                            id="btn-add-new">Add New</a>
                        </li>
                        <li class="active">
                            <a href="#all-notices" 
                            data-toggle="tab" 
                            id="btn-all-notices">All Notices</a>
                        </li>
                        <li class="pull-left header">
                            <i class="fa fa-inbox"></i> Notices
                        </li>
                    </ul>
                    <div class="tab-content no-padding">
                        <!-- Morris chart - Sales -->
                        <div class="chart tab-pane active" id="all-notices"
                            style="
                                cursor: initial; 
                                position: relative; 
                                height: 300px; 
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 90px;">
                                            <div class="btn-group pull-right">
                                                <button onclick="edit_notice(<?php echo $notice->id; ?>)"
                                                    class="btn btn-sm btn-primary">
                                                    <i class="far fa-edit"></i>
                                                </button>
                                                <button data-toggle="modal" data-target=".dialoge"
                        ...
                        <div class="chart tab-pane" id="add-notice" style="position: relative; height: 300px;">
                            <div class="col-sm-12">
